							...
							<div class="main-profile-overview">
                                ...
                                <div class="main-profile-social-list">
									...
									<div class="media">
										...
										<div class="media-body">
											<span><b>Sales Tax Certificate</b></span><a target="_blank" href="../api/v1/<?php echo $row['sales_tax_certificate']; ?>"> Click to donwload    <i title="Click here to download sales tax certificate" class="fa fa-download"></i></a>
										</div>
									</div>
                                    <div class="media">
										<div class="media-icon bg-primary-transparent text-primary">
