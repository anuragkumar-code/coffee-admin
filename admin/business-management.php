					...
					<?php } ?>
						<div class="table-responsive">
							<table class="table border-top-0  table-bordered text-nowrap border-bottom" id="responsive-datatable">
								...
								<tbody>
								<?php 
								$query = "SELECT * from users where user_type = 'business' AND status != 'D' order by id desc";
								...
								?>
									<tr>
										...
										<td class="text-center">
											<a target="_blank" href="../api/v1/<?php echo $row['sales_tax_certificate']; ?>"><i class="fa fa-download"></i></a>
										</td>
										<td class="text-center">
										...
										<td class="text-center">
											...
											<a href="javascript:void(0)" class="btn btn-sm bg-danger" title="Delete this business" onclick="deleteBusiness(<?php echo $row['id']; ?>)"><i class="fa fa-trash" ></i></a>
										</td>
									</tr>
								<?php }} ?>
								</tbody>
...
<script type="text/javascript">
	...
	function deleteBusiness(id) {
		if (confirm("Are you sure you want to delete this business?")) {
			$.ajax({
				type: 'POST',
				url: 'functions/business/delete_business.php',
				data: {
					id: id,
				},
			...
			alert("Business has not been deleted.");
		}
	}
